...
from urban_platform.sdk.base_driver import BaseDriver
from urban_platform.sdk.driver_types import ConformanceResult, DriverFetchError
...
class TemplateDriver(BaseDriver):
    ...
    def fetch(self, city_id: str, bbox: dict, *, force: bool = False) -> int:
        ...
        if not raw_data:
            from urban_platform.h3_knowledge.writer import record_ingest
        ...
        from urban_platform.h3_knowledge.writer import write_signals, record_ingest
    ...
    def _map_to_h3(self, raw_data: list, bbox: dict) -> list[dict]:
        ...
        Example using IDW for point observations:
            from urban_platform.h3_knowledge.geo_agg import aggregate_points_to_h3
    ...
    def _write_assessments(self, rows: list[dict], city_id: str) -> None:
        ...
        Example:
            from urban_platform.h3_knowledge.writer import write_assessment
