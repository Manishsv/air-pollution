...
class BuilderRegistration:
    ...
    def resolve_callable(self) -> Callable[..., Any]:
        ...
        if self.application_id == "flood_risk_dashboard_payload":
            from urban_platform.applications.flood.dashboard_payload import (  # noqa: WPS433
        ...
        if self.application_id == "flood_decision_packets":
            from urban_platform.applications.flood.decision_packets import (  # noqa: WPS433
        ...
        if self.application_id == "flood_field_verification_tasks":
            from urban_platform.applications.flood.field_tasks import (  # noqa: WPS433
        ...
        if self.application_id == "program_reporting_review_packet":
            from urban_platform.applications.program_reporting.review_packets import (  # noqa: WPS433
...
_BUILDERS: tuple[BuilderRegistration, ...] = (
    BuilderRegistration(
        ...
        callable_name="urban_platform.applications.flood.dashboard_payload.build_flood_risk_dashboard_payload",
        safety_notes=(
    ...
    BuilderRegistration(
        ...
        callable_name="urban_platform.applications.flood.decision_packets.build_flood_decision_packets",
        safety_notes=(
    ...
    BuilderRegistration(
        ...
        callable_name="urban_platform.applications.flood.field_tasks.build_flood_field_verification_tasks",
        safety_notes=(
    ...
    BuilderRegistration(
        ...
        callable_name="urban_platform.applications.program_reporting.review_packets.build_fund_release_review_packet",
        safety_notes=(
