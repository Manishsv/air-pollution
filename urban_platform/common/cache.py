...
# Preferred names for new code (aliases of the legacy names above).
load_geodata = load_cached_geodata
save_geodata = save_cached_geodata
load_dataframe = load_cached_dataframe
save_dataframe = save_cached_dataframe
