...
from airos.os.sdk.adapters import list_provider_adapter_ids
from airos.os.sdk.apps import list_app_ids
from airos.os.sdk.catalogs import list_reference_catalog_ids
from airos.os.sdk.contracts import list_contract_keys
from airos.os.sdk.deployments import list_deployment_ids


def _repo_root() -> Path:
    # SPEC_ROOT is specifications/; keep SDK inventory decoupled from API settings.
    from airos.os.specifications.conformance import SPEC_ROOT  # noqa: WPS433
