...
from airos.drivers.connectors.weather.hourly_archive import fetch_open_meteo_hourly as _legacy_fetch
from airos.os.common.cache import with_source_metadata
from airos.os.standards.converters import weather_hourly_to_observations
from airos.os.standards.validators import validate_observations
