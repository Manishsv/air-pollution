...
from airos.drivers.connectors.camera.laptop_camera import PeopleCountProvenance, read_people_count_feed
...
def _main() -> None:
    ...
    if bool(args.use_yolo):
        from airos.drivers.vision.yolo_people_count import YoloPeopleCountConfig, count_people_last_window
