...
def ingest_assessment_cells(
    ...
    *,
    ...
    """
    from airos.drivers.store.coverage import coverage_signals, distance_to_confidence, DOMAIN_DEFAULT_CONFIDENCE
...
def _apply_analysis_gate(
    *,
    ...
    if data_confidence >= _CONFIDENCE_GATE:
        ...
        try:
            from airos.drivers.store.data_quality import flag_low_confidence_cell
...
def submit_analysis_request(h3_id: str, city_id: str) -> tuple[bool, str]:
    ...
    """
    from airos.drivers.store.schema import ANALYSIS_COOLDOWN_HOURS
