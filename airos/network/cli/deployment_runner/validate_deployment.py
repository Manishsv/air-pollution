...
_REPO_ROOT_FOR_IMPORTS = _THIS_FILE.parents[4]
if str(_REPO_ROOT_FOR_IMPORTS) not in sys.path:
    sys.path.insert(0, str(_REPO_ROOT_FOR_IMPORTS))

from airos.os.deployments.config_loader import load_deployment_config  # noqa: E402
from airos.os.specifications.conformance import load_manifest  # noqa: E402
