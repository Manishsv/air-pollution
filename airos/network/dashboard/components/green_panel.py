...
from airos.apps.green.green_pipeline import (
...
from airos.network.dashboard.data_cache import load_green_cover, h3_grid_for_bbox
...
def _render_decisions_tab(packets: list[dict], city_id: str) -> None:
    ...
    from airos.os.decision_events import emit_green_decisions
