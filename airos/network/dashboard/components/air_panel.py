...
from airos.network.dashboard.data_cache import load_firms as _load_firms_shared, load_aod as _load_aod_shared
...
def render_air_panel() -> None:
    ...
    with st.spinner("Building air quality grid…"):
        ...
        if live:
            try:
                from airos.os.decision_events import emit_fire_decisions
