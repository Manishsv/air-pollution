...
from airos.network.api.audit_helpers import append_audit
from airos.network.api.receipt_helpers import (
...
from airos.apps.program_reporting.review_packets import build_program_reporting_state_summary
from airos.os.deployments.builder_registry import get_builder
from airos.os.storage import (
    FileAirOsStore,
    StoredOutput,
    StoredRecord,
    ...
    *,
    ...
    for sub in payloads:
        ...
        store.put_output(
            StoredOutput(
                ...
                generated_by="airos.apps.program_reporting.review_packets.build_fund_release_review_packet",
    ...
    store.put_output(
        StoredOutput(
            ...
            generated_at=now_utc_iso(),
            generated_by="airos.apps.program_reporting.review_packets.build_program_reporting_state_summary",
