...
imported here — all LLM calls go through airos.agents.llm_client.
...
---
    ...
    python -m airos.agents.h3_expert --city bangalore --h3 8a1b00000007fff
"""
...
class H3ExpertAgent:
    ...
    def _tool_get_signal_history(self, domain: str, signal: str, lookback_days: int = 30, **_) -> dict:
        ...
        from airos.drivers.store.reader import get_signals_history
    ...
    def _tool_get_neighbor_context(self, ring: int = 1, **_) -> dict:
        from airos.drivers.store.reader import get_neighbors_summary
    ...
    def _tool_get_city_summary(self, lookback_hours: int = 24, **_) -> dict:
        from airos.drivers.store.reader import get_city_summary
